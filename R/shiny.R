      ...
      tabPanel('heat map',
        ...
        fluidRow(
          ...
          column(3,
            ...
            'alert("tpm: Transcripts Per Million\\nest_counts: Counts/Number of aligned reads\\n',
      ...
      fluidRow(
        column(12,
          p(h3('test table'),
            ...
            'degrees_free: ??\\n\\n',
            'Gene Table Columns:\\n',
            'ens_gene: Ensemble gene ID\\n',
            'ext_gene: External gene name\\n',
            'target_id: Most significant transcript in this gene\\n',
            'pval: ??aggregate pval??\\n',
            'qval: ??\\n',
            'num_transcripts: Number of transcripts that mapped to this gene\\n',
            'all_target_ids: The list of target_ids mapping to this gene (currently not functional?)\\n',
            '");',
            '} </script>'))
          ),
          offset = 1),

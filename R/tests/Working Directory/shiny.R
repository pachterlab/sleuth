      ...
      fluidRow(   
        ...
        fluidRow(
          column(3, #figure out dynamic PC parts
            selectInput('Starting Principal Component', label = 'PC_relative', choices = 1:5,
              selected = 1)
            ),
          column(3
            numericInput('Number of Principal Components', label = 'pca_number', choices = "", value = 5,
              selected = 2)
            ),
          ),
          fluidRow(
             column(3,
                checkboxInput('pca_filt', label = 'filter',
                  value = TRUE),
                checkboxInput('scale', label = 'bool',
                  value = TRUE)
                )
            ),
        ...
        tabPanel('loadings',
          ...
          fluidRow(
            ...
            column(3,
              selectInput('Which PC', label = 'PC', choices = '',
                selected = 1)
              ),
          fluidRow(
            column(3,
